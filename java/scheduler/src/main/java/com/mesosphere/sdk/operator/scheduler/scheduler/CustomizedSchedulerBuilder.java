...
public class CustomizedSchedulerBuilder {
    ...
    public CustomizedSchedulerBuilder(
    ...
    CustomizedSchedulerBuilder(ServiceSpec serviceSpec, SchedulerConfig schedulerConfig, Persister persister) {
    ...
    private static Optional<PlanManager> getDecommissionPlanManager(
        ...
        CustomizedDecommissionPlanFactory decommissionPlanFactory =
                new CustomizedDecommissionPlanFactory(serviceSpec, stateStore, namespace);
     ...
     * to the defaults.
     */
    public CustomizedSchedulerBuilder setCustomResources(Collection<Object> customResources) {
     ...
     */
    public CustomizedSchedulerBuilder setCustomConfigValidators(
     ...
     */
    public CustomizedSchedulerBuilder setEndpointProducer(String name, EndpointProducer endpointProducer) {
     ...
     */
    public CustomizedSchedulerBuilder setPlansFrom(RawServiceSpec rawServiceSpec) {
     ...
     */
    public CustomizedSchedulerBuilder setRecoveryManagerFactory(
     ...
     */
    public CustomizedSchedulerBuilder setPlanCustomizer(PlanCustomizer planCustomizer) {
     ...
     */
    public CustomizedSchedulerBuilder withSingleRegionConstraint() {
     ...
     */
    public CustomizedSchedulerBuilder enableMultiService(String frameworkName) {
     ...
     */
    public CustomizedSchedulerBuilder setAdditionalDeserializableSubtypes(
    ...
    private CustomizedDefaultScheduler getDefaultScheduler(
            ServiceSpec serviceSpec,
        ...
        if (hasCompletedDeployment &&
            ...
            try {
                persister.set(ROLLING_UPDATE_PERSISTER_PATH, ROLLING_UPDATE_STATUS_INITIAL_DEPLOY);
            } catch (PersisterException ex) {
                logger.error("Failed to set rolling update information in persister:", ex);
            }
        }*/
        ...
        return new CustomizedDefaultScheduler(
                serviceSpec,
                schedulerConfig,
                namespace,
                customResources,
